...
\begin{figure}[p]
    ...
    \begin{tikzpicture}[remember picture, overlay]
        \node[rotate=-90, inner sep=0pt, anchor=center] at (current page.center) {
            \begin{minipage}{\paperheight}
                \centering
                \includegraphics[width=0.95\paperheight, height=0.85\paperwidth, keepaspectratio]{figures/ERD.png}
                
                \vspace{0.5cm} 
                
                
                \captionof{figure}{ByteVault Entity Relationship Diagram (ERD)}
                \label{fig:erd}
            \end{minipage}
        };
    \end{tikzpicture}
